...
impl Window {
    pub fn new() -> Result<Window, SystrayError> { Err(SystrayError::NotImplementedError) }

    pub fn quit(&self) { unimplemented!() }

    pub fn set_tooltip(&self, _: &str) -> Result<(), SystrayError> { unimplemented!() }
    ...
    pub fn wait_for_message(&mut self) { unimplemented!() }
